  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('dist/img/LaptopLogo.png') }}" alt="LAPTOP WORLD" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="add.html" class="brand-link">
      <img src="{{ asset('dist/img/LaptopLogo.png') }}" alt="Laptop Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
