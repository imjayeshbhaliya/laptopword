...
<div class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  <strong></strong> You successfully add your Brand_Name.
</div> 
@endif  
{{-- session --}}
<style>
...
<div class="card card-primary">
  ...
  <div class="card-body">
    <div class="d-flex justify-content-end">
      ...
      <form action="{{ route('category.add') }}" method="post" id="form">
        {!! csrf_field() !!}
           
        <div class="form-group pb-3">
          <label for="category_name">Brand name<span class="text-danger">*</span></label>
        <input type="text" name="name" id="name" class="form-control">
        <span style="category: red">@error('name'){{$message}}@enderror</span>
        </div>
        ...
        <span style="category: red">@error('status'){{$message}}@enderror</span>
      </br> --}}
...
$(document).ready(function(){
  $("#form").validate({
      ...
      name: {
          ...
          minlength:'The Name May Not Be Less Than 2 Characters.',
