...
Route::get('/deletecategory/{id}', [CategoryController::class,'deletedata'])->name('category.delete');
...
Route::get('/restoretrash/{id}', [CategoryController::class,'restoretrash'])->name('category.restoretrash');
});
});