                ...
                <tbody>
                    @foreach ($product as $col)
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="{{ url('/product/edit',[$col->id]) }}" class="editdata" name="{{ $col->name }}"
                                        data-id="{{ $col->id }}"><i
                                            class="far fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="{{ url('/product/deleteproduct', [$col->id]) }}" class="delete"
                                                data-id="{{ $col->id }}"><i class="fas fa-trash"></i> </a>
                                                &nbsp;
                                    <a href="{{ url('/products', [$col->url]) }}"><i class="fas fa-eye"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
