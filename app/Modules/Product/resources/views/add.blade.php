    ...
    <form action="{{ route('product.save') }}" method="post" id="form" enctype="multipart/form-data">
      ...
      <div class="col-md-12">
        ...
        <div class="form-group pb-3 pt-3">
            ...
            http://127.0.0.1:8000/product/<input type="text" name="url" id="product_input_url" class="form-control">
      ...
      <div class="form-group pb-3">
        <label for="colour_name">Product Colour<span class="text-danger">*</span></label>
