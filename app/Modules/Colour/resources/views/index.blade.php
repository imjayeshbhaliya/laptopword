    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="form-group text-right">
                <a href="{{ route('colour.add') }}" class="btn btn-outline-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                <a href="{{ route('colour.showtrash') }}" class="btn btn-outline-danger"><i class="fas fa-trash"></i> Trash</a>
            </div>
            <!-- /.card-header -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <a href="{{ url('/colour/edit',[$col->id]) }}" class="editdata" name="{{ $col->name }}"
                                        data-id="{{ $col->id }}"><i
                                            class="far fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="{{ url('/colour/deletecolour', [$col->id]) }}" class="delete"
