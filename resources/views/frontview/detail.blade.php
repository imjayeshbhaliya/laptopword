                                                ...
                                                <div class="product-img-box clearfix col-md-5 col-sm-5 col-xs-12">
                                                    <div class="product-img-content">
                                                        <div class="product-image product-image-zoom">
                                                            <div class="product-image-gallery" height="100px" >
                                                ...
                                                <div class="product-shop col-md-7 col-sm-7 col-xs-12">
                                                    <div class="product-shop-content">
                                                        ...
                                                        <div class="product-type-data">
                                                            ...
                                                            <div class="products-sku"> <span
                                                                    class="text-sku">Product
                                                                    colour: {{ $product->colour->name }}</span> demo_02
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="add-to-box">
                                                             @if ($product->stock < 1)
                                                                    <p class="availability in-stock ">Availability: <span
                                                                            style="color: red"> <h2 style="color: red"> Product out Of Stock </h2> <br> <h3 style="color: green;"> Coming soon...</h3>
                                                                        </span>
                                                                    </p>
