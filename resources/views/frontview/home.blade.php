					...
					<div class="container-none flex-index">
						<div class="flexslider">
							<div id="slider-index" class="slides">
								...
								<div class="item">
									<a  href="#"><img src="assets/images/slide3.jpg" alt="magicslider" height="900px" width="1900px"></a>
								...
								<div class="item">
									<a  href="#"> <img src="assets/images/slide2.jpg" alt="magicslider"height="900px" width="1900px" > </a>
									<div class="bx-caption ">
										<div class="container">
