                                    ...
                                    <dd class="even">
                                        <div class="slider-ui-wrap">
                                            <div id="price-range" class="slider-ui" slider-min="10000" slider-max="200000"
                                                slider-min-start="30000" slider-max-start="180000">
                                            </div>
                                        </div>
                                        ...
                                        <form action="#" class="price-range-form">
                                            ...
                                            <!-- <input type="button" class="btn-submit" onclick="reset_slider()" value="Reset" /> -->
                                        </form>
                                    </dd>
                                    <!-- <dt class="even">Default</dt> -->
                                    <dd class="even">
                                        <ol class="configurable-swatch-list color_list">
                                                <li>
                                                    <label>
                                                        <input type="button" class="btn-submit btn-block btn btn-primary" onclick="reset_slider()" value="Reset" />
                                                    </label>
                                                </li>
...
@push('front-script')
    ...
    <script>
        ...
        function reset_slider()
        {
            ...
            $('.color_check').prop('checked', false);
