                            ...
                            <div class="products-list-container">
                                <div class="images-container">
                                    <div class="product-hover">
                                        ...
                                        <a href="{{url('/products',$product->url)}}" title="" class="product-image">
                        ...
                        <div class="product-shop col-mobile-12 col-xs-7 col-md-8 col-sm-8 col-lg-8">
                            <div class="f-fix">
                                <div class="product-primary products-textlink clearfix">
                                    <h2 class="product-name"><a href="{{url('/products',$product->url)}}" title="{{$product->name}}">{{$product->name}}</a></h2>
                                ...
                                <div class="product-secondary actions-no actions-list clearfix">
                                    <p class="action"><button type="button" title="Add to Cart" class="button btn-cart pull-left" ><span><span>{{$product->category->name}}</span></span></button></p>
